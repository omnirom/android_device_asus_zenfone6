...
public class AudioSettings extends PreferenceFragment implements
    ...
    private class SettingsObserver extends ContentObserver {
        ...
        Uri ourdoorUri = System.getUriFor(SETTINGS_KEY_AUDIO_WIZARD_OUTDOOR_MODE);
        ...
        public void register(ContentResolver contentResolver) {
            contentResolver.registerContentObserver(deviceUri, false, this);
            contentResolver.registerContentObserver(ourdoorUri, false, this);
            contentResolver.registerContentObserver(modeUri, false, this);
            contentResolver.registerContentObserver(headsetEffectUri, false, this);
        }
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            Log.i("AudioWizardControllerOmni", "onChange");
            updateState();
        }
    }
    ...
    private String getSummaryString() {
        ...
        if (this.mActiveRouteNumber == -1) {
            Log.i(str2, "getSummaeyString() active route is unknown, return");
            return str3;
        }
